    ...
    <>
      <nav style={S.nav}>
        <div style={S.navInner}>
          ...
          <button style={S.navCta} onClick={scrollToForm}>Score my name</button>
        </div>
      </nav>
      ...
      <section style={S.hero}>
        <div style={S.heroInner}>
          <div style={S.heroText}>
            <div style={S.heroEyebrow}>Free Business Name Reading · 60 Seconds</div>
            <h1 style={S.heroHeadline}>Your business name has a numerology score. Here's yours.</h1>
            <p style={S.heroSub}>
              Enter your business name and birthdate. NUMRA scores whether the name is aligned with your life path — and tells you exactly why it's helping or hurting your momentum. Free, no signup.
            </p>
            <button style={S.heroCta} onClick={scrollToForm}>Score my business name →</button>
          ...
          <div style={S.heroPhone}>
            <div style={S.phoneWrap}>
              <div style={S.phoneFrame}>
                ...
                <img src="/images/screen_08.png" alt="NUMRA business name scorer" style={S.phoneScreen} />
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="signup" style={S.signupSection}>
        <div style={S.signupInner}>
          <div style={S.signupHeadlineWrap}>
            ...
            <h2 style={S.signupHeadline}>Score your business name.</h2>
            <p style={S.signupSub}>Get your business name score, alignment check, and alternatives.</p>
          </div>
          <SignupForm source="ad_business" />
        </div>
      </section>
